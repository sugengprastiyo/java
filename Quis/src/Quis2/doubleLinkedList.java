...
public class doubleLinkedList {
    ...
    public void addFirst(String nm, int nl, int nim){
        if (isEmpty()) {
            head = new Node(null, nl,nim, nm, null);
        } else {
            Node newNode = new Node(null, nl,nim, nm, null);
            head.prev = newNode;
            head = newNode;
        }
        size++;
    ...
    public void addLast(String nm, int nl, int nim){
        if (isEmpty()) {
            addFirst(nm, nl, nim);
        }else{
            Node current = head;
    ...
    public void add(String nm, int nl, int index, int nim) throws Exception{
        if (isEmpty()) {
            addFirst(nm, nl, nim);
        }
